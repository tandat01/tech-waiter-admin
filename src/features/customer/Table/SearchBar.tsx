...
import {selectCustomerListLoading, selectCustomerParams} from '../selectors';
...
const CustomerTableSearchBar = () => {
    const params = useSelector(selectCustomerParams, shallowEqual);
    const [form, formChange] = useSyncRouterQueryForm(params, customerParamsChange, ignoreSync);
    return (
        <Form form={form}
...
export default CustomerTableSearchBar;
